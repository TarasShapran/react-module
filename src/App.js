...
function App() {
  ...
  return (
    <div className="App">
      <Simpson name={simpsons[0].name} surname={simpsons[0].surname} photo={simpsons[0].photo} info={simpsons[0].info} age={simpsons[0].age}/>
      <Simpson name={simpsons[1].name} surname={simpsons[1].surname} photo={simpsons[1].photo} info={simpsons[1].info} age={simpsons[1].age} />
      <Simpson name={simpsons[2].name} surname={simpsons[2].surname} photo={simpsons[2].photo} info={simpsons[2].info} age={simpsons[2].age} />
      <Simpson name={simpsons[3].name} surname={simpsons[3].surname} photo={simpsons[3].photo} info={simpsons[3].info} age={simpsons[3].age} />
      <Simpson name={simpsons[4].name} surname={simpsons[4].surname} photo={simpsons[4].photo} info={simpsons[4].info} age={simpsons[4].age} />
